    ...
    for line in gbas_content.splitlines():
        ...
        if match_timer:
            ...
            if delay > 0:
                ...
                command_str = None # Reset command_str to avoid double processing
                command_byte_size = 0 # Reset command_byte_size to avoid double processing
